  ...
  Widget build(BuildContext context) {
    ...
    final list = [
      ...
      Onboard(
        ...
        subtitle:
            'Pick genres, moods, and favorites so CineBot can suggest spot-on movies.',
        lottie: 'pick',
      ),
      ...
      Onboard(
        ...
        subtitle:
            'Ask CineBot for recommendations anytime. From thrillers to rom-coms, it’s got you covered.',
        lottie: 'bot',
      ),
    ];
